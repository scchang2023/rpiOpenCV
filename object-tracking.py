...
def print_hsv(frame, lower_bound, upper_bound):
    ...
    cv2.putText(frame, "lower_bound: "+ str(upper_bound), (5, window_size-40), font, 0.4, (0, 255, 255), 1)
...
def update(x):
    ...
    upper_bound[0]=cv2.getTrackBarPos("lower_hue", "window")
    upper_bound[1]=cv2.getTrackBarPos("lower_sat", "window")
    upper_bound[2]=cv2.getTrackBarPos("lower_val", "window")
